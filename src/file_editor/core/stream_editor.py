...
class StreamEditor:
    ...
    def process_chunks(
        self,
        processor: Callable[[Union[bytes, str]], Union[bytes, str]],
    ...
    def process_lines(
        self,
        processor: Callable[[str], Optional[str]],
        output_path: Optional[Union[str, Path]] = None,
    ) -> Optional[Path]:
    ...
    def filter_lines(
        ...
        return self.process_lines(
            lambda line: line if predicate(line) else None, output_path
        )
    ...
    def tail(self, n: int = 10) -> list[str]:
        ...
        return list(deque((line.rstrip("\n") for line in self.read_lines()), maxlen=n))
...
class ContextAwareStreamEditor(StreamEditor):
    ...
    def process_with_context(
        self,
        condition_func: Callable[[str, deque], bool],
...
def stream_copy_with_transform(
