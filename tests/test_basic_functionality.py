...
from file_editor import AgentFileSystem, MarkdownEditor, TextEditor, MmapEditor
...
class TestAgentFileSystem:
    ...
    def test_modify_file_section(self):
        ...
        # Replace lines 2-3
        success = self.agent_fs.modify_file_section("test.txt", 2, 3, "New Line 2\nNew Line 3")
        assert success
...
"""
        ...
        success = editor.edit_section_streaming("Section 2", "This is NEW section 2 content.")
        assert success
...
"""
        ...
        editor = MarkdownEditor(self.test_file)
        success = editor.insert_section("New Section", "New content here", 
                                      level=2, after_section="Section 1")
        assert success
